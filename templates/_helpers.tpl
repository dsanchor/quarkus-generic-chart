...
*/}}
{{- define "quarkus-generic.fullname" -}}
...
Selector labels
*/}}
{{- define "quarkus-generic.selectorLabels" -}}
app.kubernetes.io/name: {{ include "quarkus-generic.name" . }}
